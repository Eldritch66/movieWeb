...
export default function ToggleWatchlistButton({ movie, px, text, mt }) {
  ...
  return (
    <div className={`mt-${mt} w-full}`}>
      <button
        className={`border-2 flex items-center justify-center gap-2 px-${px} py-2 rounded-xl font-base cursor-pointer transition-colors  ${
          isSaved
